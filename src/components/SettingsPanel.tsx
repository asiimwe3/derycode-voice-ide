  ...
  return (
    <>
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-full max-w-md animate-slide-up">
        <div className="bg-ide-surface border border-ide-border rounded-xl shadow-2xl overflow-hidden">
          {/* Header */}
          ...
          <div className="p-5 space-y-6 max-h-[70vh] overflow-y-auto">
            ...
            <section className="pt-4 border-t border-ide-border">
              <p className="text-xs text-ide-muted">
                Derycode Voice IDE v0.2.0 — Built with Next.js, Monaco Editor, and the Web Speech API.
              </p>
            </section>
          </div>
        </div>
